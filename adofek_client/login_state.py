...
class LoginWindow:
    ...
    def create_frame_layer(self):
        self.login_frame = tkinter.Frame(
            self.window, bg='blue', width=950, height=600,
        )
        self.login_frame.place(x=200, y=70)
        self.txt = 'WELCOME'
        self.heading = tkinter.Label(
            self.login_frame, text=self.txt,
            font=('yu gothic ui', 25, 'bold'), fg='white',
            bg='blue',
        )
    ...
    def create_username_input(self):
        self.username_txt = tkinter.Label(
        ...
        self.username_entry = tkinter.Entry(
            self.login_frame, highlightthickness=0,
            relief=tkinter.FLAT,
            width=25, font=('yu gothic ui', 13, 'bold'),
            fg='black', bg='blue',
        )
        self.username_entry.place(x=680, y=250)
        self.username_line = tkinter.Canvas(
            self.login_frame, width=250, height=2.0,
    ...
    def create_username_logo(self):
        self.username_icon = Image.open(
            'image projects\\images\\username_icon.png',
        )
        photo = ImageTk.PhotoImage(self.username_icon)
        self.username_icon_panel = tkinter.Label(
            self.login_frame, image=photo, bg='blue',
        )
    ...
    def create_password_input(self):
        self.password_txt = tkinter.Label(
        ...
        self.password_line = tkinter.Canvas(
            self.login_frame, width=250, height=2.0,
            bg='white', highlightthickness=0,
        )
    ...
    def create_password_logo(self):
        self.password_icon = Image.open(
            'image projects\\images\\password_icon.png',
        )
        photo = ImageTk.PhotoImage(self.password_icon)
        self.password_icon_panel = tkinter.Label(
            self.login_frame, image=photo, bg='blue',
        )
    ...
    def create_login_button(self):
        ...
        self.lgn_icon_panel = tkinter.Label(
            self.login_frame, image=photo, bg='blue',
        )
        ...
        self.login_button = tkinter.Button(
            self.lgn_icon_panel, text='L O G   I N',
    ...
    def create_forget_password_button(self):
        self.forget_pass_btn = tkinter.Button(
            self.login_frame, text='Forget Password ?',
            font=('yu gothic ui', 13, 'bold underline'),
            width=25, bd=0, cursor='hand2', fg='white',
            background='blue', height=1,
        )
