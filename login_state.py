...
class LoginWindow:
    ...
    def create_frame_layer(self):
        self.login_frame = Frame(self.window, bg="blue", width=950, height=600)
        self.login_frame.place(x=200, y=70)
        self.txt = "WELCOME"
        self.heading = Label(self.login_frame, text=self.txt, font=("yu gothic ui", 25, "bold"), fg="white", bg="blue")
    ...
    def create_logo(self):
        ...
        self.bg_logo = Label(self.login_frame, image=photo, bg="blue")
    ...
    def create_sign_in_layer(self):
        ...
        self.sign_panel = Label(self.login_frame, image=photo, bg="blue")
        self.sign_panel.image = photo
        self.sign_panel.place(x=700, y=30)
        self.sign_in_txt = Label(self.login_frame, text="Sign In", font=("yu gothic ui", 18, "bold"),
                                 fg="white", bg="blue")
        self.sign_in_txt.place(x=730, y=150)

    def create_username_input(self):
        self.username_txt = Label(self.login_frame, text="Username", font=("yu gothic ui", 15, "bold"),
                                  fg="black", bg="blue")
        self.username_txt.place(x=650, y=220)
        self.username_entry = Entry(self.login_frame, highlightthickness=0, relief=FLAT, width=25
                                    , font=("yu gothic ui", 13, "bold"), fg="black", bg="blue")
        self.username_entry.place(x=680, y=250)
        self.username_line = Canvas(self.login_frame, width=250, height=2.0,
    ...
    def create_username_logo(self):
        ...
        self.username_icon_panel = Label(self.login_frame, image=photo, bg="blue")
        self.username_icon_panel.image = photo
        self.username_icon_panel.place(x=650, y=250)

    def create_password_input(self):
        self.password_txt = Label(self.login_frame, text="Password", font=("yu gothic ui", 15, "bold"),
                                  fg="black", bg="blue")
        self.password_txt.place(x=650, y=320)
        self.password_entry = Entry(self.login_frame, highlightthickness=0, relief=FLAT, width=25
                                    , font=("yu gothic ui", 13, "bold"), fg="black", bg="blue", )
        self.password_entry.place(x=680, y=350)
        self.password_line = Canvas(self.login_frame, width=250, height=2.0,
                                    bg="white", highlightthickness=0)
    ...
    def create_password_logo(self):
        ...
        self.password_icon_panel = Label(self.login_frame, image=photo, bg="blue")
    ...
    def create_login_button(self):
        ...
        self.lgn_icon_panel = Label(self.login_frame, image=photo, bg="blue")
        self.lgn_icon_panel.image = photo
        self.lgn_icon_panel.place(x=640, y=400)

        self.login_button = Button(self.lgn_icon_panel, text="L O G   I N", font=("yu gothic ui", 13, "bold"),
    ...
    def create_password_show_or_hide_button(self):
        ...
        self.hide_icon_panel = Label(self.login_frame, image=photo, bg="blue")
        ...
        self.show_icon_panel = Label(self.login_frame, image=photo, bg="blue")
        self.show_icon_panel.image = photo
        # self.show_icon_panel.place(x=910, y=390)

    def create_forget_password_button(self):
        self.forget_pass_btn = Button(self.login_frame, text="Forget Password ?",
