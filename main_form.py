...
class MainForm:
    ...
    def create_image_label(self):
        file = tkinter.filedialog.askopenfile(title="send file",
    ...
    def create_frame_layer(self):
        self.main_frame = tkinter.Frame(self.window, bg="blue", width=self.win_width - 80,
                                        height=self.win_height - 80)
        self.main_frame.place(x=40, y=40)

    def create_text_entry(self):
        self.chat_entry = tkinter.Entry(self.main_frame, width="30",
                                        borderwidth="3", font="none 10 bold", justify="center",
                                        highlightthickness=5, highlightcolor="green")
        self.chat_entry.place(x=150, y=450)
        self.btn_send = tkinter.Button(self.main_frame, text="Send", font="none 12 bold",
                                       bg="green", highlightcolor="white",
                                       highlightthickness=5)
        self.btn_send.place(x=400, y=450)
        self.file_btn = tkinter.Button(self.main_frame, text="add file", font="none 12 bold",
                                       bg="green", highlightcolor="white",
